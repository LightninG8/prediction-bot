...
'Ваш совет очень поможет близкому человеку',

'Все усилия, которые вы прилагаете, в конечном итоге окупятся',

'Все проблемы, которые у вас сейчас есть, очень быстро пройдут',

'У вас все получится с новым проектом',

'Вся ваша тяжелая работа скоро даст плоды',

'Позвольте интуиции руководить вашими решениями',

'Знакомый из прошлого повлияет на вас в ближайшем будущем',

'У вас может скоро завязаться приятный роман',

'Важный человек предложит вам поддержку',

'Любое решение, которые вы примете завтра, будет хорошим решением',

'Будьте осторожны, или вы можете стать жертвой обмана',

'Вам нужно подумать о работе в сфере красоты или искусства',

'Так как вы привыкли быть требовательным к себе, вы завоюете уважение окружающих',

'Поверьте в себя, и окружающие поверят в вас',

'Верьте, что все возможно',

'Лучше дважды спросить, чем один раз потерять',

'Не торопитесь, успех уже близок',

'В вашей жизни сейчас происходят перемены, плывите по течению',

'Ваш профессионализм явно недооценен, но скоро все изменится',
...
'Отстранитесь от тщеславия',

'Не берите на себя дополнительную работу',

'Не стоит себя недооценивать. У вас безграничный потенциал',

'Не опускайте руки, потому что каждая неудачная попытка становится еще одним шагом вперед',

'Не тратьте время зря. Вкладывайте',
...
'Вы сможете выйти победителем в давней ситуации',
...
'В конце концов, вам все станет известно',

' Лучше справляться с проблемами до того, как они появятся',

'Пришло время двигаться. Ваше состояние заметно улучшится',

'Прислушивайтесь к окружающим. Идеи появляются везде',

'Вас ждет долгая жизнь',

'Никогда не бойся. Конец одного означает начало чего-то нового',

'Новые люди помогут вам многое понять по-новому, особенно в отношении важных вопросов',

'Пришло время двигаться вперед, вас ждет новое любовное увлечение',

'Сейчас вы можете попробовать что-то новое',

' Вас ожидает прибавление в семействе',

'Любовный роман движется в вашем направлении',

'Человек, который вам небезразличен, ищет примирения',
...
'Вас ждет восхищение окружающих за ваши таланты и способности',

'Вас ждет обновление гардероба',
